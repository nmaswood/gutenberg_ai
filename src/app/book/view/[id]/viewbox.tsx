...
export const ViewBox = ({ book }:{book:Book}) => {
    ...
    const handleSummarize = async () => {
        ...
        ///console.log(LLMData.choices[0].message.content)
        if (LLMData && LLMData.choices[0].message.content) {
            setContent(LLMData.choices[0].message.content); // Assuming the response has a summary field
        }
    };
    // Function to handle summarizing the book
    ...
    return (
        <>
            ...
            <div className="space-y-2 mb-4">
                ...
                <button className="bg-gray-500 text-white font-bold py-2 px-4 rounded">Something Else</button>
            </div>
